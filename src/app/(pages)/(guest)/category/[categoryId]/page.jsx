...
export default async function CategoryAdsPage({ params, searchParams }) {
  ...
  const adCount = await adsByThisCategory(categoryId, "Not Sold")
    ...
    <div className="bg-body">
      <div className="w-full max-w-7xl mx-auto px-4 pb-20 lg:pb-10">
        <div className="my-5 font-semibold text-base pt-5 flex items-center gap-2">
          ...
          <span>ক্যাটেগরী</span> » {category_name}
        </div>

        <h1 className="font-medium text-2xl pb-5">
          {category_name} ক্যাটেগরীতে বিজ্ঞাপন সমূহ - {adCount} টি
        </h1>
            ...
            <div className="bg-white border border-borderColor rounded-md">
              ...
              <div>
                ...
                <div className="mt-2 px-4">
                  <p className="my-4">
                    <input type="checkbox" />{" "}
                    <label className="ml-2">ঢাকা বিভাগ</label>
                  </p>
                  <p className="my-4">
                    <input type="checkbox" />{" "}
                    <label className="ml-2">চট্টগ্রাম বিভাগ</label>
                  </p>
                  <p className="my-4">
                    <input type="checkbox" />{" "}
                    <label className="ml-2">রাজশাহী বিভাগ</label>
                  </p>
                  <p className="my-4">
                    <input type="checkbox" />{" "}
                    <label className="ml-2">খুলনা বিভাগ</label>
                  </p>
                  <p className="my-4">
                    <input type="checkbox" />{" "}
                    <label className="ml-2">সিলেট বিভাগ</label>
                  </p>
                  <p className="my-4">
                    <input type="checkbox" />{" "}
                    <label className="ml-2">বরিশাল বিভাগ</label>
                  </p>
                  <p className="my-4">
                    <input type="checkbox" />{" "}
                    <label className="ml-2">রংপুর বিভাগ</label>
                  </p>
                  <p className="my-4">
                    <input type="checkbox" />{" "}
                    <label className="ml-2">ময়মনসিংহ বিভাগ</label>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="flex items-center justify-end">
          <Paggination
            count={adCount}
            nextLink={`/category/${categoryId}?category_name=${category_name}`}
          />
        </div>
      </div>
    </div>
